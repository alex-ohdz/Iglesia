...
const BoxText = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-sanctuary-gold/30 py-7 text-sanctuary-shadow">
      <h1 className="mb-6 text-center font-display text-3xl text-sanctuary-terracotta">
      ...
      <div className="w-full flex items-center lg:flex-row flex-col md:items-center justify-items-start">
        ...
        <p
          ref={ref}
          className={`fade-up mx-6 max-w-full text-center font-body leading-relaxed lg:mx-20 lg:text-left ${
            isVisible ? "visible" : ""
          }`}
        >
