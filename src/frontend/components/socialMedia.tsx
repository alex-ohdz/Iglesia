  ...
  return (
    <div className="mt-1 flex gap-3">
      <Link
        ...
        className="text-sanctuary-terracotta transition hover:text-sanctuary-gold"
      >
        <InstagramIcon />
      </Link>
      <Link
        href="sdf"
        aria-label="Facebook"
        className="text-sanctuary-sky transition hover:text-sanctuary-terracotta"
      >
        <FacebookIcon />
      </Link>
      <Link
        href="ad"
        aria-label="YouTube"
        className="text-sanctuary-shadow transition hover:text-sanctuary-terracotta"
      >
        <YouTubeIcon />
      </Link>
    </div>
